                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="text-header" style="color:#000; font-family:'Noto Sans', Arial,sans-serif; font-size:12px; line-height:16px; text-align:left; text-transform:uppercase;">
                                                                            ...
                                                                            Sub: Your Bank Payment has been successful received! <br>
                                                                            Paper ID: <b>{{$payment->paper_id}}</b>
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td class="text pb20" style="color:#777777; font-family:'Noto Sans', Arial,sans-serif; font-size:14px; line-height:26px; text-align:justify; padding-bottom:20px;">
                                                            <p>Your Bank Payment has been successfully done!</p>
                                                            <p><b>Paper ID: {{$payment->paper_id}}</b></p>
