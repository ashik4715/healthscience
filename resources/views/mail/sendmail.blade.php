                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="text-header" style="color:#999999; font-family:'Noto Sans', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;">
                                                    <!-- <img src="https://www.sdippress.com/images/category_logo/jamfm-5d0f3f5586a58.png" alt="" width="150" style="background-color: white;margin: -13px; padding: 5px; border-radius: 2px;"> -->
                                                    <!-- <img src="https://www.sdippress.com/images/category_logo/{{$category->logo}}" alt="" width="150" style="background-color: white;margin: -13px; padding: 5px; border-radius: 2px;"> -->
                                                </td>
                                            </tr>
                                        </table>
                                    </th>
