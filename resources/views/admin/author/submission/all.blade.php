                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th class="text-center" width="5%">Author Name</th>
                                <th class="text-center" width="5%">A. Key</th>
                                <th class="text-center" width="15%">Paper. ID</th>
                                <th class="text-center" width="8%">S. Country</th>
                                <th class="text-center" width="3%">VPN</th>
                                <th class="text-center" width="20%">Paper Title</th>
                                <th class="text-center" width="5%">Date</th>
                                <th class="text-center" width="3%">Payment</th>
                                <th class="text-center" width="4%">Status</th>
                                <th class="text-center" width="10%">Action</th>
                                <th class="text-center" width="2%">Auto</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php($sl = 1)
                            @foreach($submits as $submit)
                                <tr>
                                    ...
                                    <td>{{$submit->paper_access_key}}</td>
                                    <td>{{$submit->paper_id}}</td>
                                    <td>{{$submit->country}}</td>
